<template>
  <div>
    <el-card class="box-card">
      ...
      <!-- 
      Table
        ----border属性可以设置表格纵向是否有边框 
      table-column
        ----align="center"属性设置文字对其方式
        ----width属性设置列宽
      -->
    ...
    <el-dialog v-model="dialogFormVisible" :title="trademarkParams.id ? '修改品牌' : '添加品牌'">
      <!--:model="trademarkParams"，:rules="rules" ref="formRef"用于表单校验  -->
...
//品牌自定义校验规则方法
//rule：校验规则对象，value：文本框的内容，callBack：相应的放行函数
